...
export class DailyShipReportService {

    private mdata$ = new BehaviorSubject<Daily_Ship_Report_Model>(null);
    get data$(): Observable<Daily_Ship_Report_Model> {
        return this.mdata$.asObservable();
    }
    private record: Daily_Ship_Report_Model;
    ...
    List(SearchData: any) {
        return this.http2.post<any>(this.gs.baseUrl + '/api/Report/DailyShipReport', SearchData, this.gs.headerparam2('authorized'));
    }
