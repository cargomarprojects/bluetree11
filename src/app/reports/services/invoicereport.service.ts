...
import { TBL_INV_LIST, InvoiceReportModel } from '../models/tbl_inv_list';
...
export class InvoiceReportService {
    ...
    private mdata$ = new BehaviorSubject<InvoiceReportModel>(null);
    get data$(): Observable<InvoiceReportModel> {
        return this.mdata$.asObservable();
    }
    private record: InvoiceReportModel;
    ...
    public ClearInit() {
        this.record = <InvoiceReportModel>{
            sortcol: '',
            sortorder: true,
            errormessage: '',
            records: [],
    ...
    List(SearchData: any) {
        return this.http2.post<any>(this.gs.baseUrl + '/api/Report/InvoiceReport/List', SearchData, this.gs.headerparam2('authorized'));
    }
}
