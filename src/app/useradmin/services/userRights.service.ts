...
export class UserRightsService {
    ...
    private mdata$ = new BehaviorSubject<User_Access_Model>(null);
    get data$(): Observable<User_Access_Model> {
        return this.mdata$.asObservable();
    }
    private record: User_Access_Model;
    ...
    RefreshList(_rec: Tbl_User_Access) {
        if (this.record.records == null)
            return;
        var REC = this.record.records.find(rec => rec.ua_pkid == _rec.ua_pkid);
        if (REC == null) {
